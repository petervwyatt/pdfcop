 ...
 */
package com.itextpdf.pdfcop.text.textshowing;
...
public class ShowTextTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                { "Hello World Tj", false, "Hello World", "Tj" }
        });
    }
    ...
    public ShowTextTest(String syntaxToCheck, boolean pass, String operand, String operator) {
    ...
    public void test() {
        ...
        PdfStreamParser.TextShowContext context = streamParser.textShow();
