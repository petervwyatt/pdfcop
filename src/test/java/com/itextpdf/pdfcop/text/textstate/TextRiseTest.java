...
public class TextRiseTest {
    ...
    public TextRiseTest(String syntaxToCheck, boolean pass, int operand, String operator) {
    ...
    public void test() {
        ...
        PdfStreamParser.TextRiseContext context = streamParser.textRise();
