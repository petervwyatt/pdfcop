...
public class MiterLimitTest {
    ...
    public MiterLimitTest(String syntaxToCheck, boolean pass, float operand, String operator) {
    ...
    public void test() {
        ...
        PdfStreamParser.MiterContext context = streamParser.miter();
