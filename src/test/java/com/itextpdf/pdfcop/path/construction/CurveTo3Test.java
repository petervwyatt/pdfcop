...
public class CurveTo3Test {
    @Rule
    public ExpectedException expectedException = ExpectedException.none();
    @Parameterized.Parameters
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { "0 1 2 3 y", true, new int[] {0, 1, 2, 3}, "y" },
                { "0 1 2 y", false, new int[] {0, 1, 2, 3}, "y" }
        });
    }
    ...
    public CurveTo3Test(String syntaxToCheck, boolean pass, int[] operands, String operator) {
    ...
    public void test() {
        ...
        PdfStreamParser.CurveTo3Context  context = streamParser.curveTo3();
