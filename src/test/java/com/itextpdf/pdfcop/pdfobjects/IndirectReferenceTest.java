...
public class IndirectReferenceTest {
    ...
    public IndirectReferenceTest(String value, boolean pass) {
        this.value = value;
        this.pass = pass;
    }
    ...
    public void test() {
        ...
        PdfStreamLexer streamLexer = new PdfStreamLexer(CharStreams.fromString(this.value));
